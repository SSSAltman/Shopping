...
//			if(action.equals("add")) {//如果商品添加进购物车
...
//				}
//			}
//			if(action.equals("show")) {//如果商品显示购物车
...
//		
//		//是否是第一次添加商品,给session中创建一个新的购物车对象
...
public class CartServlet extends HttpServlet {
	...
	private String username; //表示客户的姓名
...
//		this.username=request.getParameter("username");
		...
		//System.out.println("what   "+username);这里用session没啥问题
