...
<%
String path = request.getContextPath();//根目录
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      { 
         ...
         window.location.href="<%=path%>"+"/servlet/CartServlet?id="+id+"&num="+num+"&action=add&username="+name;
//          alert("hhhhh");
...
<%--     J.dialog.get({id: 'haoyue_creat',title: '购物成功',width: 600,height:400, link: '<%=path%>/servlet/CartServlet?id='+id+'&num='+num+'&action=add', cover:true}); --%>
  ...
  <body>
    ...
    <hr>
    <center>
      <table width="700" height="60" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <!-- 商品详情 -->
          <% 
          ...
          <td width="70%" valign="top">
             ...
             %>
					 <a
							href="javascript:selflog_show(<%=item.getId()%>,<%=realname%>)">
							<img src="images/in_cart.png">
						</a><a href="servlet/CartServlet?action=show"><img
...
<!--         <b><font color="#FF7F00">在不同浏览器上会因为Cookie导致禁用</font></b><br> -->
<!--         <b><font color="#FF7F00">故注释掉，老师有空的话可以看下源码</font></b><br> -->
<!--         循环开始 -->
<%--         <%  --%>
<!-- <!--  -->
